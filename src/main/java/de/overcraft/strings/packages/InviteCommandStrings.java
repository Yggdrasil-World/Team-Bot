...
public interface InviteCommandStrings {
    ...
    interface REQUEST {
        String RESPONDER_REQUESTING_MESSAGE = "Requesting invite:";
        String RESPONDER_DENY_MESSAGE = "Requesting invite: **Denied!**";
        String RESPONDER_ALLOW_MESSAGE = "Requesting invite: **Approved!**";
